...
public static class ChainloaderLogHelper
{
    ...
    private static string GetPlatformString()
    {
        ...
        var is64Bit = (architecture & ArchitectureKind.Bits64) != 0;
        builder.Append(is64Bit ? " 64-bit" : " 32-bit");
        ...
        if (architecture == ArchitectureKind.Arm || architecture == ArchitectureKind.Arm64)
        {
            builder.Append(" ARM");
